...
app.use(cors({origin: ['https://yazamut-komi.surge.sh','http://localhost:8082','http://localhost:8081','http://localhost:8080','https://localhost:8080','http://10.43.16.40:8080']}));
